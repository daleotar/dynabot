...
void QDynMesh::computeFaceNormals()
{
...
QDynMesh::QDynMesh(QString meshFileName)
{
    ...
    vertices = new QDynMeshVertex[nVert];
    faces = new QDynMeshFace[nFace];
    materials = new QDynMeshMaterial[nMate];
