...
QDynPath::QDynPath(QString filename)
{
    ...
    points = new QDynPathPoint[nPoints];
    pointsFile->reset();
    int iPoint = 0;
    totalDistance = 0;
...
QDynPath::QDynPath(double xIni,double yIni, double zIni, double xFin, double yFin, double zFin, int n)
{
    points = new QDynPathPoint[n];
    nPoints = n;
...
void QDynPath::setProp(int prop, QVariant value)
{
    switch(prop)
    {
        case 0:
